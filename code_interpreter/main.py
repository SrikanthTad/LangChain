...
def main():
    ...
    #                             that point to https://www.linkedin.com/in/sritad/, you have qrcode package installed already"""
    # )
        ...
        tools=[
            Tool(
                ...
                description="""useful when you need to transform natural language and write from it python and execute the python code,
                            ...
                            DO NOT SEND PYTHON CODE TO THIS TOOL""", #since it needs to take in the natural language instead
            ),
            Tool(
                name="CSVAgent",
                func=csv_agent.run,
